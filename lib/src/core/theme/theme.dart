...
ThemeData lightMode = ThemeData().copyWith(
  colorScheme: const ColorScheme.light()
      .copyWith(background: AppColor.appBg, primary: AppColor.appBlack),
  ...
  datePickerTheme: const DatePickerThemeData().copyWith(
      ...
      headerHeadlineStyle: GoogleFonts.lato(fontSize: 30, color: Colors.white),
...
ThemeData darkMode = ThemeData().copyWith(
  ...
  dialogTheme:
      const DialogThemeData(contentTextStyle: TextStyle(color: AppColor.white)),
  datePickerTheme: const DatePickerThemeData().copyWith(
    elevation: 5,
    shadowColor: Colors.black,
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
