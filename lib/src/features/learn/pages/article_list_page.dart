...
class ArticleListPage extends StatelessWidget {
  ...
  const ArticleListPage({super.key, this.isPremium = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ArticleListPageController>(
    builder: (cnt){
          if (cnt.searchResults.value.isNotEmpty) {
             return GetX<ArticleListPageController>(
               builder: (contx) {
                       ...
                       children: [
                         ...
                         for (var article in contx.searchResults.value)
                           ListTile(
                             ...
                             onTap: () {
                               var index = contx.articles.value
                                   .indexWhere((element) => element == article);
                               if (index != -1) {
                                 Get.to(
                                     () => ArticlePage(
                                           article: article,
                                           ctl: contx.articleControllers[index],
                                         ),
            ...
            if (cnt.articles.value.isNotEmpty) {
              return GetBuilder<ArticleListPageController>(
                builder: (cont) {
                  return Stack(
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ClipRRect(
                                  ...
                                  child: Image.network(
                                    cont.currentCategoryImage.value,
                                    loadingBuilder:
                                      ...
                                      if (loadingProgress == null) {
                                        ...
                                        final double? loadingValue = loadingProgress
                                            .expectedTotalBytes !=
                                            null
                                            ? loadingProgress
                      ...
                      ? AppColor.white
                        ...
                        child: SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount: cont.categoryList.value.length,
                              itemBuilder: (BuildContext context, int index) {
                                String chatName = cont.categoryList.value[index];
                                return Row(
                                  children: [
                                    AppSizing.w04,
                                    GestureDetector(
                                      onTap: () async => await cont.loadCategoryData(cont.categoryList.value[index]),
                                      child: Card(
                                        elevation: 0,
                                        ...
                                        color: Get.theme.brightness == Brightness.light
                                            ? AppColor.grey200.withOpacity(0.3)
                                            : AppColor.darkAppNavBar,
                                        child: Padding(
                                          padding:
                            ...
                            children: [
                              SvgPicture.asset(
                                  Get.theme.brightness == Brightness.light
                                      ? Assets.emptyArchiveImg
                                      : Assets.emptyArchiveImgDark),
                              AppSizing.h28,
                              Text(
