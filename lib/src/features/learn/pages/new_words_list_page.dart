...
class NewWordsListPage extends StatelessWidget {
  const NewWordsListPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final ctl = Get.put(NewWordListController('',''));
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Obx(() {
                  if (ctl.wordsList.isNotEmpty) {
                    return ListView.builder(
                      shrinkWrap: true,
                      physics: const NeverScrollableScrollPhysics(),
                      itemCount: ctl.wordsList.length,
                      itemBuilder: (BuildContext context, int index) {
                        var word = ctl.wordsList[index].word;
                        var meaning = ctl.wordsList[index].meaning;
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(word, style: AppTextStyle.bodyMedium(context)),
                                        AppSizing.h04,
                                      ],
                                    ),
                                    GestureDetector(
                        ...
                        children: [
                          SvgPicture.asset(
                              Get.theme.brightness == Brightness.light
                                  ? Assets.emptyNewWordsImg : Assets.emptyNewWordsDarkImg),
                          AppSizing.h28,
                          Text('No words saved', style: AppTextStyle.h4Regular(context)),
                          Text('To have new words, go to the learn page, read articles, and save new words.',
