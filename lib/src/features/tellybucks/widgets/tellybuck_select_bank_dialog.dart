...
class TellyBucksSelectBankDialog extends StatelessWidget {
  final TellybucksDashboardPageController ctl;
  final int selectedIndex;
  const TellyBucksSelectBankDialog(
