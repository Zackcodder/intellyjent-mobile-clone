import 'package:intellyjent/src/features/top_up/widgets/bank_ussd_buttons.dart';

import '../../../core/core.dart';

class SelectUSSDialog extends StatelessWidget {
  final VoidCallback onTap;
  final USSDPageController ctl;
  const SelectUSSDialog(
      {super.key,
        required this.onTap, required this.ctl});
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipOval(
                        ...
                        child: Text('*#', style: AppTextStyle.h5(context),)),
                  ),
                  AppSizing.h32,
